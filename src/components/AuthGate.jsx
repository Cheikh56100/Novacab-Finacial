   ...
   <section className="authShell">
    ...
    <div className="authGrid">
      ...
      <div className="authCard">
       ...
       <div className="eyebrow">ESPACE SÉCURISÉ</div><h2>{mode==="login"?"Bienvenue dans NOVACAB Insight":"Créer votre espace NOVACAB Insight"}</h2><p>{mode==="login"?"Utilisez les mêmes identifiants que NOVACAB : vos dossiers, votre équipe et vos droits sont automatiquement récupérés.":"Créez un espace indépendant pour importer vos propres sociétés et effectuer vos comparaisons, sans accès aux données NOVACAB."}</p>
